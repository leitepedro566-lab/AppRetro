...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // "即将开始静默下载安装 v%@，完成后系统会自动更新安装。"
    NSString *msg = [NSString stringWithFormat:HEX_DEC("E58DB3E5B086E5BC80E5A78BE99D99E9BB98E4B88BE8BDBDE5AE89E8A38520762540EFBC8CE5AE8CE68890E5908EE7B3BBE7BB9FE4BC9AE887AAE58AA8E69BB4E696B0E5AE89E8A385E38082"), verStr];
    ...
    [alert addAction:[UIAlertAction actionWithTitle:HEX_DEC("E5BC80E5A78BE9998DE7BAA7") style:UIAlertActionStyleDestructive handler:^(UIAlertAction * _Nonnull action) { // "开始降级"
        ...
        // 2. 🎯 点击确认后，立即执行私有特权 API，实现完美的挂起并平滑自动返回桌面
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Warc-performSelector-leaks"
        id app = [NSClassFromString(HEX_DEC("55494170706C69636174696F6E")) performSelector:NSSelectorFromString(HEX_DEC("73686E617265644170706C69636174696F6E"))]; // UIApplication / sharedApplication
        SEL suspSel = NSSelectorFromString(HEX_DEC("73757370656E64")); // "suspend"
